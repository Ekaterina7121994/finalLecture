...
> **Не валидные значения поля "Имя"**
> * оставить поле не заполненным
> * состоящее из 1 символа на кириллице: Я
> * состоящее из цифр: 12345
> * состоящее из спецсимволов: +Х"№@

> **Не валидные значения поля "Телефон"**
> * оставить поле не заполненным
> * ввести данные в поле на кириллице: тырапаыыл
> * ввести данные в поле на латинице: gfsskgh
> * ввести данные в поле спецсимволами: +Х"№@
> * ввести в поле ввода 9 символов цифрами: 765543655
> * ввести в поле ввода 12 символов цифрами: 789645698766

> **Не валидные значения поля "email@email.ru"**
> * оставить поле не заполненным
> * Email без точек в доменной части: email@emailru
> * Превышение длины email: >320 символов
> * Отсутствие @ в email: emailemail.ru
> * Email с пробелами в имени аккаунта: e mail@email.ru
> * Email с пробелами в доменной части: email@e mail.ru
> * Email без имени аккаунта: @email.ru
> * Email без доменной части: email@
> * Некорректный домен первого уровня: допустимо 2-63 букв после точки: .ru или например .americanexpress
...
*Ожидаемый результат:* поле "Имя" подсвечивается красным, под ним появляется надпись "Обязательное поле".
...
*Ожидаемый результат:* поле "Телефон" подсвечивается красным, под ним появляется надпись "Обязательное поле".

### 1.3.4 Отправка запроса записи на курс оставив поле "email@email.ru" пустым
1. В поле "Имя" ввести валидное значение
2. В поле "Телефон" ввести валидное значение
3. Поле "email@email.ru" оставить не заполненным
4. Нажать на кнопку "Записаться"

*Ожидаемый результат:* поле "email@email.ru" подсвечивается красным, под ним появляется надпись "Обязательное поле".

### 1.3.5 Отправка запроса записи на курс заполнив поле "Имя" НЕ валидным значением
1. В поле "Имя" ввести НЕ валидное значение
2. В поле "Телефон" ввести валидное значение
3. В поле "email@email.ru" ввести валидное значение
4. Нажать на кнопку "Записаться"
