...
### 1.3.6 Отправка запроса записи на курс заполнив поле "Имя" НЕ валидным значением
...
### 1.3.7 Отправка запроса записи на курс заполнив поле "Телефон" НЕ валидным значением
1. В поле "Имя" ввести валидное значение:
2. В поле "Телефон" ввести НЕ валидное значение:
...
### 1.3.8 Отправка запроса записи на курс заполнив поле "Электронная почта" НЕ валидным значением
1. В поле "Имя" ввести валидное значение:
2. В поле "Телефон" ввести валидное значение
3. В поле "Электронная почта" ввести НЕ валидное значение
...
*Ожидаемый результат:* поле "Электронная почта" подсвечивается красным, под ним появляется надпись "Неверный email".
