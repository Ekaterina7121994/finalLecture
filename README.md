...
**Важно:** Перед выполнением каждого Test case необходимо возвращаться на страницу записи на обучение профессии [«Тестировщик ПО»](https://netology.ru/programs/qa#/order)
